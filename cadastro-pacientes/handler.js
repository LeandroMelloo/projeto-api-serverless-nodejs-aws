...
module.exports.cadastrarPaciente = async (event) => {
  try {
    ...
    return {
      statusCode: 201,
      body: JSON.stringify('Paciente cadastrado com sucesso!', null, 2),
    };
  } catch (err) {
    console.log("Error", err);
    return {
...
module.exports.atualizarPaciente = async (event) => {  
  ...
  try {
    ...
    return {
      statusCode: 204,
      body: JSON.stringify('Paciente atualizado com sucesso!', null, 2),
    };
  } catch (err) {
    console.log("Error", err);
...
module.exports.excluirPaciente = async event => {
  ...
  try {
    ...
    return {
      statusCode: 200,
      body: JSON.stringify('Paciente excluido com sucesso!', null, 2),
    }
  } catch (err) {
    console.log("Error", err);
